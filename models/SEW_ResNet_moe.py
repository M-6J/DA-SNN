...
class MoEGateNetwork(nn.Module):
    def __init__(self, in_channels, num_experts):
        ...
        self.bn1 = nn.BatchNorm3d(32)  # 🔥 Conv3D에 맞게 변경
        self.conv2 = nn.Conv3d(32, num_experts, kernel_size=(3, 3, 3), padding=(1, 1, 1))
...
def sew_resnet_moe(block, layers, **kwargs):
    return SEW_ResNet_MoE(block, layers, **kwargs)

def dta_sewresnet_moe(**kwargs):
