...
if __name__ == '__main__':
    ...
    if args.DS == 'dvs_gesture':
        ...
        train_dataset = dvs128_gesture.DVS128Gesture(root='/kaggle/input/test-dvs128/DVS  Gesture dataset', train=True, data_type='frame', frames_number=args.time_step,
                                                     split_by='number')
        val_dataset = dvs128_gesture.DVS128Gesture(root='/kaggle/input/test-dvs128/DVS  Gesture dataset', train=False, data_type='frame', frames_number=args.time_step,
                                                    split_by='number')
