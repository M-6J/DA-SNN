...
if __name__ == '__main__':
    ...
    if args.DS == 'DVSGesture':
        dataset_train = dvs128_gesture.DVS128Gesture(root='D:\DTA\dataset\DVS_Gesture', train=True, data_type='frame', frames_number=T,
                                                     split_by='number', transform=trm)
        dataset_test = dvs128_gesture.DVS128Gesture(root='D:\DTA\dataset\DVS_Gesture', train=False, data_type='frame', frames_number=T,
                                                    split_by='number', transform=trm)
