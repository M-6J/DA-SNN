...
def main():
    ...
    parser.add_argument('-data_dir', default='./dataset/DVS_Gesture', type=str, help='root dir of DVS128 Gesture dataset')
    parser.add_argument('-out_dir', default='tcja_test/', type=str, help='root dir for saving logs and checkpoint')
